...
let nameDsp = document.getElementById('fullname_dsp'),
    ...
    linkDsp = document.getElementById('link_dsp'),
...
const getUserInputs = () => {
    ...
    let linkElem = document.querySelectorAll('.link');
    ...
    linkElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'link')));
    return {
        ...
        link: fetchValues(['link'], linkElem),
    }
};
...
const displayCV = (userData) => {
    ...
    showListData(userData.link, linkDsp);
